...
import com.cxk.nwuhelper.BaseConstant.LOGIN_URL
...
//    val n = MutableLiveData()
    ...
    fun visitWebsite() {
        ...
        val connect: Connection = Jsoup.connect(LOGIN_URL)
//        connect.header(USER_AGENT, USER_AGENT_VALUE) // 配置模拟浏览器
    ...
    private fun loginWebsite(cookies: Map<String, String>, stringStringMap: Map<String, String>) {
        ...
        val connect = Jsoup.connect(LOGIN_URL).cookies(cookies).followRedirects(false)
